...
})({"2W6WC":[function(require,module,exports) {
...
if (document.querySelector("#cursor")) {
    const cursor = (0, _srcDefault.default)();
    cursor.init();
}
// Donut Cursor
if (document.querySelector("#donut-cursor")) {
    ...
    const donutCursor = (0, _srcDefault.default)(donutOpts);
    donutCursor.init();
}
if (document.querySelector("#blend-cursor ")) {
    ...
    const blendCursor = (0, _srcDefault.default)(blendOpts);
    blendCursor.init();
}
...
exports.default = (0, _animatedCursorJsDefault.default);
 ...
 */ function AnimatedCursor(options) {
   ...
   */ function onMouseLeave(e) {
        if ((0, _hasExitedViewportDefault.default)(e)) {
            settings.isVisible = false;
            toggleVisibility();
        }
    }
   ...
   */ function animateOuterCursor() {
        ...
        settings.cursorPos.x = (0, _lerpDefault.default)(settings.cursorPos.x, settings.targetPos.x, opts.trailingSpeed);
        settings.cursorPos.y = (0, _lerpDefault.default)(settings.cursorPos.y, settings.targetPos.y, opts.trailingSpeed);
   ...
   */ function setCursorStyles() {
        ...
        (0, _setStylesDefault.default)(opts.cursorInnerSelector, styles);
        (0, _setStylesDefault.default)(opts.cursorOuterSelector, styles);
        (0, _setStylesDefault.default)(opts.cursorInnerSelector, opts.cursorInnerStyles);
        (0, _setStylesDefault.default)(opts.cursorOuterSelector, opts.cursorOuterStyles);
    }
    /**
   ...
   */ function setCursorColor() {
        const colorInner = (0, _hexToRgbDefault.default)(opts.color);
        const colorOuter = (0, _hexToRgbDefault.default)(opts.color, opts.outerAlpha);
   ...
   */ function setOuterBorder() {
        settings.cursorOuter.style.setProperty("border", `${opts.outerBorderSize}px solid ${opts.color}`);
    }
    /**
...
},{"./utils/lerp":"29c7x","./utils/has-exited-viewport":"dFz2H","./utils/hex-to-rgb":"f3xdV","./utils/set-styles":"2fU8I","./utils/is-touch-device":"lIQdL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"29c7x":[function(require,module,exports) {
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>lerp);
function lerp(a, b, n) {
    return (1 - n) * a + n * b;
}
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>hasExitedViewport);
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>hexToRGB);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>setStyles);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lIQdL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["2W6WC","86ByF"], "86ByF", "parcelRequire1176")

//# sourceMappingURL=blend.27ad7d95.js.map
